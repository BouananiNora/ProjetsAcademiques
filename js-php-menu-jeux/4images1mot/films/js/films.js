 ...
 * @param {number} ptsA_Ajt - Le nombre de points à ajouter.
 */
function addPoints(ptsA_Ajt) {
    points += ptsA_Ajt;
...
function passerNiveauSuivant() {
    ...
    stopTimer();
    if (checkifcorrect(niveauActuel)) 
    { //si le mot saisi est correct
        var finTemps = new Date();
        ...
        setTimeout(function() { //pause
            ...
            setTimeout(function() {  //encore petite pause
                if (niveauActuel < totalNiveau) {
                    ...
                    saveProgress4img("film", totalPoints);
